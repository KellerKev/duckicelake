...
The deep reference for [duckicelake](../README.md) — the full feature
inventory, governance internals, endpoint/config tables, and repository
layout. Start with the [README](../README.md) for the what-and-why.
...
The [README](../README.md) covers the governance model and the
byte-level tier; this is the full authoring/composition/hardening
detail.
...
Design details: [docs/multi_catalog_isolation.md](multi_catalog_isolation.md).
